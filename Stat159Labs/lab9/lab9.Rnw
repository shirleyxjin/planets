...
<<regression table, echo=False, results = tex>>=
library(xtable)
load(file = "regression.RData")
print(xtable(summary(regression),caption="Information about Regression Coefficients"),type = "latex", comment = FALSE)
@
...
<<summary stats table, echo = FALSE, results=tex>>=
...
print(table_rqi,type="latex",comment=FALSE)
@
